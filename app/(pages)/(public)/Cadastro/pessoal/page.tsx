    ...
    <main className={mainContainer()}>
      ...
      <div className={formContainer()}>
        ...
        <form className="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-6 w-full">
          <div>
            <label className="text-sm mb-1 block">Primeiro nome:</label>
            <Input />
          </div>

          <div>
            <label className="text-sm mb-1 block">Segundo nome:</label>
            <Input />
          </div>

          <div className="flex w-full gap-4 col-span-1 sm:col-span-2">
            <div className="flex flex-col flex-1 max-w-[120px]">
              <label className="mb-1 font-medium">DDD:</label>
              <input
                type="text"
          ...
          <div>
            <label className="text-sm mb-1 block">Cpf:</label>
            <Input />
          </div>

          <div>
            <label className="text-sm mb-1 block">Endereço do email:</label>
            <Input />
          </div>
        ...
        <div className="w-full flex justify-center mt-10">
          <div className="w-44 sm:w-48">
            <Button
            onClick={() => router.push("/Cadastro/endereco")}>Continuar</Button>
          </div>
        </div>
      </div>
    </main>
